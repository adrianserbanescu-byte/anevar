...
REGISTRU: list[dict] = [
    {"slug": "ghid-start", "categorie": "Ghid de utilizare",
     "titlu": "Bun venit — start aici", "fisier": "ghid/00-start.md",
     "descriere": "Cum folosești aplicația, în 4 pași. Începe de aici."},
    {"slug": "ghid-pornire", "categorie": "Ghid de utilizare",
     "titlu": "Pasul 1 — Cont și primul dosar", "fisier": "ghid/01-pornire.md",
     "descriere": "Configurarea contului și cele 5 moduri de a deschide un dosar."},
    {"slug": "ghid-dosar", "categorie": "Ghid de utilizare",
     "titlu": "Pasul 2 — Completarea dosarului", "fisier": "ghid/02-dosar.md",
     "descriere": "Descrierea proprietății, datele, formatele și confidențialitatea."},
    {"slug": "ghid-calcul", "categorie": "Ghid de utilizare",
     "titlu": "Pasul 3 — Comparabile și calcul", "fisier": "ghid/03-calcul.md",
     "descriere": "Cele 3 grile, cele 3 abordări și reconcilierea valorii."},
    {"slug": "ghid-raport", "categorie": "Ghid de utilizare",
     "titlu": "Pasul 4 — Generarea raportului", "fisier": "ghid/04-raport.md",
     "descriere": "Anexe, asumarea răspunderii, generarea și versiunile."},
    {"slug": "ghid-conformitate", "categorie": "Ghid de utilizare",
     "titlu": "Conformitate AML / GDPR", "fisier": "ghid/05-conformitate.md",
     "descriere": "Ce documente faci, ce verifici manual. Drafturi — validează cu jurist."},
    {"slug": "ghid-faq", "categorie": "Ghid de utilizare",
     "titlu": "Întrebări frecvente", "fisier": "ghid/06-faq.md",
     "descriere": "Răspunsuri scurte la cele mai des întâlnite întrebări."},
